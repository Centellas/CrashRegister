...
void printarDades(int16_t ejeX, int16_t ejeY, int16_t ejeZ, int16_t maxX, int16_t maxY, int16_t maxZ)
{
	...
	dip204_printf_string("X: %.2fg ", ejeY/4096.0);	// Para 8G dividir entre 4096.0
	dip204_printf_string("mX: %.2fg ", maxY/4096.0);
	
	dip204_set_cursor_position(1,3);
	dip204_printf_string("X: %.2fg ", ejeZ/4096.0);	// Para 8G dividir entre 4096.0
	dip204_printf_string("mX: %.2fg ", maxZ/4096.0);
}